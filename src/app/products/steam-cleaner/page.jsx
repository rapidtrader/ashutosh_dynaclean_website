...
import data from "@/data/Steam-cleaner/data";
...
const Scrubber = () => {
  ...
  const cardData = {
    images: [
      "/Product/steam-cleaner/1.webp",
      "/Product/steam-cleaner/1.webp",
      "/Product/steam-cleaner/1.webp",
      "/Product/steam-cleaner/1.webp",
    ],
    url: "/products/steam-cleaner/D-Steam2",
    title: data.title,
  ...
  return (
    <main>
      <ResponsiveSection
        imagePath="/Product/steam-cleaner/1.webp" // public directory
