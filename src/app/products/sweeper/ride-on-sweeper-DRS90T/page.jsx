...
export const metadata = {
  title: "DRS- 90 T Ride on Sweeper Machine",
  description:
  ...
  keywords:
    "battery operated Sweeper, Sweeper machine, Ride on sweeper, battery sweeper, floor sweeper, floor cleaning machine, cleaning machine, ride on sweeper machine",
  openGraph: {
    type: "website",
    title: "DRS- 90 T Ride on Sweeper Machine",
    description:
